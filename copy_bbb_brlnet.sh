...
rsync -avzh ./launch/*.launch					BBB_BRLNET:/home/ubuntu/uwesub_catkin_workspace/src/hw_loop/launch/
...
rsync -avzh ./urdf/*.urdf						BBB_BRLNET:/home/ubuntu/uwesub_catkin_workspace/src/hw_loop/urdf/
